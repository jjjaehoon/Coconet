...
import com.coconet.server.dto.StatusDto;
...
public class UserStatusController {
    ...
    public void statusBreak(@RequestHeader("Jwt_Access_Token") String accessToken, @RequestBody StatusDto statusDto) {
        UserStatus findUserStatus = userStatusRepository.findByNum(statusDto.getNum()); // Users 테이블의 num을 가져와 UserStatus 테이블에서 PK가 일치하는 컬럼을 찾음
        findUserStatus.setStatus(status.WORK_BREAK); // 현재 유저 상태를 '휴식중'으로 변경
